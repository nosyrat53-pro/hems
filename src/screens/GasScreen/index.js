...
import GasChart from '../../components/GasChart/index';
...
export default function GasScreen() {
  ...
  useEffect(() => {
    ...
    if(startTime && endTime){
      ...
      setIsFilter(true);
      console.log(`http://home-ems.herokuapp.com/api/gas/consumption/index?start_date=${startTime}&end_date=${endTime}`);

    axios.get(`http://home-ems.herokuapp.com/api/gas/consumption/index?start_date=${startTime}&end_date=${endTime}`, 
  ...
  <Grid item xs={12} md={8} lg={9}>
      ...
      <Title > جدول استهلاك الغاز </Title>
