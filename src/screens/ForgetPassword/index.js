...
export default function SignInSide() {
  ...
  const handleSubmit = (event) => {
    ...
    axios.post(`http://home-ems.herokuapp.com/api/forgot?email=${data.get('email')}`)
    .then(data => {
      console.log('data from login',data.data);
      setSuccessMessage('Check your email please , to reset your password')
      
      localStorage.setItem('saved_email',data.get('email'));
    })
    .catch(error => {
